 ...
 * \param [in] inscalar_PearsonCoefficientKernel_sample_size Input scalar parameter "PearsonCoefficientKernel.sample_size".
...
void PearsonCoefficient(
	...
	double inscalar_PearsonCoefficientKernel_sample_size,
...
typedef struct { 
	...
	double inscalar_PearsonCoefficientKernel_sample_size; /**<  [in] Input scalar parameter "PearsonCoefficientKernel.sample_size". */
