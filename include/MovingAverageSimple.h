 ...
 * 
 * \param [in] instream_x The stream should be of size 400000 bytes.
 * \param [in] instream_y The stream should be of size 400000 bytes.
 * \param [out] outstream_coefficient The stream should be of size 16 bytes.
 * \param [out] outstream_coefficient4 The stream should be of size 16 bytes.
 */
void MovingAverageSimple(
	const float *instream_x,
	const float *instream_y,
	float *outstream_coefficient,
	float *outstream_coefficient4);
 ...
 */
typedef struct { 
	const float *instream_x; /**<  [in] The stream should be of size 400000 bytes. */
	const float *instream_y; /**<  [in] The stream should be of size 400000 bytes. */
	float *outstream_coefficient; /**<  [out] The stream should be of size 16 bytes. */
	float *outstream_coefficient4; /**<  [out] The stream should be of size 16 bytes. */
